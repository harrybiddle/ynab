...
class TestCommaFloat(unittest.TestCase):
    ...
    def test_exception_when_casting_decimal_float_with_thousands_separator(self):  # noqa
        with self.assertRaises(ValueError):
...
class TestCSVConverstion(unittest.TestCase):
    ...
    valid_entry_format = ('"1203059441";"26.10.17";"{date}";'
                          '"ONLINE-UEBERWEISUNG";"{memo}";"";"";"";"";"";"";'
                          '"{payee}";''"GB79101111100264565115";"HGNKDEEFXYX";'
                          '"{amount}";"EUR";"Transaction volume posted"')

    def valid_entry(self, date, payee, memo, amount):
        return self.valid_entry_format.format(date=date, payee=payee,
    ...
    def test_conversion(self):
        ...
        a = [self.valid_header,
             self.valid_entry('26.10.17', 'Mary Smith',
