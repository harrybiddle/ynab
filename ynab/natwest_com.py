...
class Natwest (Bank):
    natwest_secret = collections.namedtuple('Secret', ('consumer_number pin natwest_password ynab_password'))

    full_name = "Natwest"

    def prompt(self):
        print ('Enter a semicolon separated list of natwest consumer number, '
    ...
    def _log_in_customer_number(secret, driver):
    ...
    def _select_characters(secret, texts_requesting_pin_digits,
    ...
    def _log_in_pin_and_password(secret, driver):
